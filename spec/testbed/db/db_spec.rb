...
describe 'Database' do
  before do
    ...
    @author_repo.create(name: "John Doe")
  end
  ...
  it 'creates authors with books' do
    book_1 = @book_repo.create(title: 'Abc')
    book_2 = @book_repo.create(title: 'Xyz')
  ...
  it 'uses entities' do
    assert_equal "Full name: John Doe", @author_repo.first.full_name
  end
end
